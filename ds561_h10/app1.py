...
INSTANCE_CONNECTION_NAME = "jacks-project-398813:us-central1:deployment-sql-instance"
DB_USER = "root"
DB_PASS = "1234"
DB_NAME = "deployment-sql-db"
...
def files_get(filename):
    ...
    if method != 'GET':
        ...
        if country not in banned:
            ...
            bucket = client.bucket('deployment-bucket-1')
            ...
            topic_path = publisher.topic_path('jacks-project-398813', 'deployment-topic-banned-countries')
